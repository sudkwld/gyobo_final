    ...
    $.ajax({
      ...
      .done(function (msg) {
        ...
        for (var i = 0; i < sliderShowBook.length; i++) {
          ...
          $(showBookImg).eq(i).append("<a href='sub.html'>" + "<img src='" + msg.documents[i].thumbnail + "'/" + "</a>");
          $(sliderShowBook).eq(i).append("<h3>" + "<a href='sub.html'>" + "[" + msg.documents[i].title + "]" + "</a>" + "</h3>");
          $(sliderShowBook).eq(i).append("<h4>" + "<a href='sub.html'>" + str2 + "</a>" + "</h3>");
        }
      });